...
class ReminderListViewController: UICollectionViewController {
    ...
    let listStyleSegmentedControl = UISegmentedControl(items: [ReminderListStyle.past.name, ReminderListStyle.today.name, ReminderListStyle.future.name, ReminderListStyle.all.name])

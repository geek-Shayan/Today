...
//  Today
//
//  Created by MD. SHAYANUL HAQ SADI on 30/1/23.
//
...
extension Reminder {
    static var sampleData = [
        ...
        Reminder(title: "Past test", dueDate: Date().addingTimeInterval(-1081000.0),  notes: "past test check"),
        Reminder(title: "Past test 1", dueDate: Date().addingTimeInterval(-1087000.0),  notes: "past test check 11"),
    ]
}
